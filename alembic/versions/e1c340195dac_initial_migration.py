...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['current_map_point_id'], ['map_point.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['map_point_id'], ['map_point.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['end_point_id'], ['map_point.id'], ),
    sa.ForeignKeyConstraint(['start_point_id'], ['map_point.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['owner_entity_id'], ['game_entity.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
